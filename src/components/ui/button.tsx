  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-primary-glow text-primary-foreground shadow-warm hover:shadow-glow hover:scale-105 transition-all duration-300",
        cooking: "bg-card text-card-foreground shadow-card hover:shadow-warm border border-border hover:border-primary/30 transition-all duration-300",
        voice: "bg-voice-active text-white hover:bg-voice-active/90 transition-all duration-300",
        timer: "bg-cooking-timer text-white hover:bg-cooking-timer/90 transition-all duration-300",
      },
      size: {
